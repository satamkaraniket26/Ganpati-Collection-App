...
function resetDonationForm() {
    ...
    const donorName =
        document.getElementById("donationDonorName");

    const mobile =
        document.getElementById("donationMobile");

    const purpose =
        document.getElementById("donationPurpose");

    const paymentMode =
        document.getElementById("donationPaymentMode");

    const status =
        document.getElementById("donationStatus");

    const cashAmount =
        document.getElementById("donationCashAmount");

    const upiAmount =
        document.getElementById("donationUPIAmount");

    const totalAmount =
        document.getElementById("donationTotalAmount");

    const remark =
        document.getElementById("donationRemark");

    const sendWhatsapp =
        document.getElementById("donationSendWhatsapp");

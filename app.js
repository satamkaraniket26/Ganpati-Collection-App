...
"₹" + Number(data.paidVargani).toLocaleString();

document.getElementById("pendingVargani").innerHTML =
"₹" + Number(data.pendingVargani).toLocaleString();

document.getElementById("politicalTotal").innerHTML =
"₹" + Number(data.politicalPaid).toLocaleString();

document.getElementById("vendorTotal").innerHTML =
"₹" + Number(data.vendorPaid).toLocaleString();
...
const balance =
    Number(data.paidVargani) +
    Number(data.politicalPaid) +
    Number(data.vendorPaid) +
    Number(data.recovery) -
    Number(data.expenses);
...
async function loadHomeDashboard(){
    ...
    try{
        ...
        document.getElementById("pendingRecovery").innerHTML =
            "₹" + Number(dashboard.pendingVargani || 0).toLocaleString();

        document.getElementById("cashCollection").innerHTML =
        "₹" + Number(daily.cashCollection).toLocaleString();

        document.getElementById("onlineCollection").innerHTML =
        "₹" + Number(daily.onlineCollection).toLocaleString();

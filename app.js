...
async function loadDashboard() {
    ...
    try {
        ...
        /*
         * Recovery is NOT added separately.
         *
         * When Recovery is completed, the original
         * Vargani / Vendor record becomes Paid.
         *
         * Therefore recovered amounts are already included
         * in the paid collection totals.
         */
         ...
         * onlineExpenses
         *
         * based on the Payment Mode column
         * in the Expenses sheet.
         *
         * If these values are not returned,
         * they will currently be treated as ₹0.
         */
